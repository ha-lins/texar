...
flags.DEFINE_string(
    "vocab_file", 'bert/bert_pretrained_models/uncased_L-12_H-768_A-12/all.vocab.txt',
...
def prepare_data():
    ...
    #i.g. Concat x' with y and see whether x' was compressed in y 
    ref = refs[1]
    ...
    with open("{}/ckpt/hypos.step{}.val.txt".format(expr_name, step), 'r') as f_sent:
