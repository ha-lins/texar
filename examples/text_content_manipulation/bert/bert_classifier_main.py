...
def main(_):
	...
	iterator = tx.data.FeedableDataIterator({
		'train': train_dataset, 'eval': eval_dataset, 'test1': test_dataset_1, 'test2': test_dataset_2})
	...
	lr = config_downstream.lr['static_lr']
	...
	def _test_epoch(sess, which_score):
		...
		output_file = os.path.join(FLAGS.output_dir, "results_{}.tsv".format(which_score))
